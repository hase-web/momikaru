...
export const EVENT_TYPES = {
  interview: {
    id: "interview",
    label: "面接",
    durationMinutes: Number(process.env.EVENT_INTERVIEW_MINUTES || 30),
  },
  interview_online: {
    id: "interview_online",
    label: "オンライン面接",
    durationMinutes: Number(process.env.EVENT_INTERVIEW_ONLINE_MINUTES || 30),
  },
};
...
export function getWorkingHours() {
  return {
    ...
    endHour: Number(process.env.WORK_END_HOUR || 19),
