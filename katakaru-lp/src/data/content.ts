...
export const hero = {
  ...
  lead:
    '肩こりは、放っておくと一日を確実に削っていきます。「肩がこっています」と伝えたのに、なぜか全身まんべんなく——そんな失敗、もう繰り返さなくていい。かたかるは、30分間ずっと、肩と首だけに集中するメニューです。今度こそ、お金も時間も、ちゃんとあなたの肩のために使われます。',
  prices: {
    primary: {
      duration: '30分',
      price: '2,700円',
...
export const stolenThings = {
  ...
  lead:
    '「肩がこっている」は、ただの不快感ではありません。慢性化した肩こりは、気づかないうちに、あなたの一日のいろいろな場面を確実に削っています。',
  items: [
    {
      index: 1,
      title: '仕事のパフォーマンス',
      body:
        '午後の会議で、相手の話が頭に入らない。資料を読んでも文字が滑る。「歳のせいかも」と思っていませんか? それは年齢ではなく、肩と首のこりが脳への血流を妨げている結果です。本来出せるはずの集中力と判断力が、肩の重さに削られています。',
    },
    {
      index: 2,
      title: '良質な睡眠',
      body:
        '朝起きても、スッキリしない。週末を寝て過ごしても、疲れが抜けない。これは、眠っている間も首と肩の筋肉が緊張し続けている証拠です。深い睡眠が取れない毎日が、翌日のあなたの体力をさらに削っていきます。',
    },
    {
      index: 3,
      title: '大切な人との時間の質',
    ...
    },
    {
      ...
      title: '「以前の自分」',
      body:
        '鏡を見ると、姿勢が崩れている。表情がいつも疲れている。気づけば、頭痛薬とカフェインで一日を凌いでいる。以前の自分は、こうではなかったはず。その違和感は、肩こりが日常を侵食している警告です。',
    },
  ],
  closing:
    '肩こりは、放置していい不調ではありません。今日の重さは、明日のあなたを削っていきます。だから、解放するなら、早いほうがいい。',
  closingHighlight: '今日の重さは、明日のあなたを削っていきます。',
} as const;
  ...
  features: [
    {
      ...
      body:
        'メニューレベルで「肩と首だけ」と確約しています。施術者の判断・解釈に依存せず、誰についても同じ集中ケアが構造として保証されます。',
    },
    {
      index: 2,
      title: '「ハズレ」が、ほぼなくなる',
    ...
    },
    {
      ...
      body:
        '深層までしっかり届く30分の集中ケアが、業界最安水準で受けられます。慢性化した肩こりを「根っこから」解放するために設計されたコースです。',
    },
  ],
} as const;
...
export const pricing = {
  ...
  lead:
    'かたかるには30分と20分の2つのコースがあります。もみかるが本気で設計し、自信を持っておすすめするのは、30分コースです。両コースとも施術範囲は同じ「肩と首」ですが、届く深さが違います。\n\n特に重要なのが「9〜18分」の深層筋アプローチ。慢性化した肩こりの「重さの正体」は、この深層筋にあります。30分コースだからこそ、ここに10分以上の時間を確保できる。これが20分コースとの本質的な違いです。',
  ...
  plans: [
    {
      ...
      area: '肩と首',
      depth: '表層・中層・深層まで',
      approach: 'ほぐし、深層筋への圧、多方向からのケア、ストレッチ、仕上げ流し',
  ...
  recommendation: {
    heading: 'プラン選びに迷ったら',
    body:
      '初めての方は、必ず30分コースをお選びください。慢性化した肩こりは、表層をほぐしただけでは戻ってしまいます。一度しっかり深層までほぐして「根っこ」を取り除いたうえで、20分コースで維持していく——これが、もみかるが提案する通い方です。',
...
export const existingMenuPosition = {
  ...
  closing: '両方を組み合わせて使うお客様が、結果的に最も満足度が高いです。',
} as const;
...
export const finalCta = {
  heading: '肩、軽くしましょう。',
  body:
    '肩と首に、30分間ずっと集中。深層から根っこを取り除く。誰についても、ハズレの少ない安心を。今日の重さは、今日のうちに解放してください。',
...
export const seo = {
  ...
  description:
    '「肩がこってる」と伝えたのに全身まんべんなく揉まれた経験はありませんか? かたかるは、肩と首だけに30分集中するメニュー。深層まで届く施術で、誰についてもハズレの少ない安心を。全国136店舗のもみかる。',
} as const;
